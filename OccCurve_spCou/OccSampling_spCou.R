# This script is made to test the occurrence curve against the literature curve


# Starting from this section in the main BDE workflow...

# Build a plot of the points and the model
(litOccCurve_spCou_forCurve <-ggplot2::ggplot(data = allOccCounts_spCountry,
                                        ggplot2::aes(x = n_occ_spCou, y = count)) +
  ggplot2::geom_function(fun = function(x){ (-0.68833 + (217.51375/(x)))}, 
                         ggplot2::aes(color = "red"), linetype = 1, size = 1) +
...
litTibble <- dplyr::tibble(
  x_coords = ggplot2::ggplot_build(litOccCurve_spCou_forCurve)$data[[1]]$x,
  y_coords = ggplot2::ggplot_build(litOccCurve_spCou_forCurve)$data[[1]]$y)
...
readr::write_excel_csv(country_speciesCounts, "OccCurve_spCou/Table_outputs/1.7_country_speciesCounts.csv")
if(!exists("country_speciesCounts")){
  country_speciesCounts <- readr::read_csv("OccCurve_spCou/Table_outputs/1.7_country_speciesCounts.csv")
}
...
continentChecklist <- BeeBDC::beesChecklist(URL = "https://figshare.com/ndownloader/files/47092720") %>% 
...
countryNOTcontinent <- dplyr::symdiff(continentOccs$name_continent, continentChecklist$name_continent) %>%
...
##### 1.9 Save ####
# Save these files 
readr::write_excel_csv(countryChaoData_checklist, file = "OccCurve_spCou/Table_outputs/1.9_countryChaoData_checklist.csv")
readr::write_excel_csv(country_speciesChecklistCounts, file = "OccCurve_spCou/Table_outputs/1.9_country_speciesChecklistCounts.csv")
readr::write_excel_csv(beeData_totalCounts, file = "OccCurve_spCou/Table_outputs/1.9_beeData_totalCounts.csv")
readr::write_excel_csv(continentCounts, file = "OccCurve_spCou/Table_outputs/1.9_continentCounts.csv")
readr::write_excel_csv(continentWider, file = "OccCurve_spCou/Table_outputs/1.9_continentWider.csv")


# Read them in if needed
if(!exists("countryChaoData_checklist")){
  countryChaoData_checklist <- readr::read_csv("OccCurve_spCou/Table_outputs/1.9_countryChaoData_checklist.csv")
}
if(!exists("country_speciesChecklistCounts")){
  country_speciesChecklistCounts <- readr::read_csv("OccCurve_spCou/Table_outputs/1.9_country_speciesChecklistCounts.csv")
}
if(!exists("beeData_totalCounts")){
  beeData_totalCounts <- readr::read_csv("OccCurve_spCou/Table_outputs/1.9_beeData_totalCounts.csv")
}
if(!exists("continentWider")){
  continentWider <- readr::read_csv("OccCurve_spCou/Table_outputs/1.9_continentWider.csv")
}
...
readr::write_csv(taxonomy_valid, "OccCurve_spCou/Table_outputs/2.1a_taxonomy_valid.csv")
readr::write_csv(validCounts, "OccCurve_spCou/Table_outputs/2.1a_validCounts.csv")
readr::write_csv(INvalidCounts, "OccCurve_spCou/Table_outputs/2.1a_INvalidCounts.csv")
...
readr::write_csv(occYear_counts, "OccCurve_spCou/Table_outputs/2.1a_occYear_counts.csv")
...
# Save the plot
ggplot2::ggsave(paste0("OccCurve_spCou/Figure_outputs/","2.1ac_TaxoOccCurve_spCou.pdf"), 
                plot = TaxoOccPlot, 
...
# Save the plot
ggplot2::ggsave(paste0("OccCurve_spCou/Figure_outputs/","2.1b_SynonymCurve.pdf"), 
...
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","2.1b_Curves.pdf"),
                   plot = accumCurves,
                   base_width = 8,
                   base_height = 8)
...
base::saveRDS(globalChao, 
              file = "OccCurve_spCou/2.2a_globalChao.Rda")
...
base::saveRDS(countryChao_n1, 
              file = "OccCurve_spCou/2.2b_countryChao.Rda")
...
base::saveRDS(continentChao_n1, 
              file = "OccCurve_spCou/2.2c_continentChao.Rda")

###### d. read in if needed ####
if(!exists("globalChao")){
  globalChao <- readRDS("OccCurve_spCou/2.2a_globalChao.Rda")
}
if(!exists("countryChao_n1")){
  countryChao_n1 <- readRDS("OccCurve_spCou/2.2b_countryChao.Rda")
}
if(!exists("continentChao_n1")){
  continentChao_n1 <- readRDS("OccCurve_spCou/2.2c_continentChao.Rda")
}
...
base::saveRDS(global_iNEXT_out, 
              file = "OccCurve_spCou/2.3a_globaliNEXT.Rda")
...
ggplot2::ggsave(global_iNEXTplot, device = "pdf", path = paste0(getwd(), "/OccCurve_spCou/Figure_outputs/country_iNEXT"),
...
base::saveRDS(country_iNEXT, 
              file = "OccCurve_spCou/2.3b_country_iNEXT.Rda")
if(!exists("country_iNEXT")){
  country_iNEXT <- base::readRDS("OccCurve_spCou/2.3b_country_iNEXT.Rda")
}
...
country_summary <- ggiNEXTwrapper(data = country_iNEXT,
                                  ...
                                  labels = NULL,
                                  fileName = "iNEXTplots",
                                  outPath = "/Users/jamesdorey/Desktop/Uni/My_papers/BeeDiversityEstimates/BDE_R_wofklow/OccCurve_spCou/Figure_outputs/country_iNEXT",
                                  base_width = 8.3,
                                  base_height = 11.7, 
                                  dpi = 300)

# Save this data table
readr::write_excel_csv(country_summary, file = paste0("/Users/jamesdorey/Desktop/Uni/My_papers/BeeDiversityEstimates/BDE_R_wofklow/OccCurve_spCou/Figure_outputs/country_iNEXT",
...
base::saveRDS(continent_iNEXT, 
              file = "OccCurve_spCou/2.3c_continent_iNEXT.Rda")
...
# Save this data table
readr::write_excel_csv(continent_summary, file = paste0("/Users/jamesdorey/Desktop/Uni/My_papers/BeeDiversityEstimates/BDE_R_wofklow/OccCurve_spCou/Figure_outputs/country_iNEXT",
                                                        "/2.3c_continentTable.csv"))

###### d. read in if needed ####
if(!exists("global_iNEXT_out")){
  global_iNEXT_out <- readRDS("OccCurve_spCou/2.3a_globaliNEXT.Rda")
}
if(!exists("country_iNEXT")){
  country_iNEXT <- base::readRDS("OccCurve_spCou/2.3b_country_iNEXT.Rda")
}
if(!exists("continent_iNEXT")){
  continent_iNEXT <- base::readRDS("OccCurve_spCou/2.3c_continent_iNEXT.Rda")
}
if(!exists("continent_summary")){
  continent_summary <- base::readRDS("OccCurve_spCou/2.3c_continentTable.csv")
}
...
richnessInputs %>%
  base::saveRDS(., 
                file = "OccCurve_spCou/2.4a_richnessInputs_spCou.Rda")
if(!exists("richnessInputs")){
  richnessInputs <- base::readRDS("OccCurve_spCou/2.4a_richnessInputs_spCou.Rda")
}
...
# Save
globalSampled %>%
  base::saveRDS(., file = "OccCurve_spCou/2.4b_globalSampled.Rda")
...
if(!exists("globalSampled")){
  globalSampled <- base::readRDS("OccCurve_spCou/2.4b_globalSampled.Rda")
}
...
# Save
countrySampled %>%
  base::saveRDS(., file = "OccCurve_spCou/2.4c_countrySampled_spCou.Rda")
# Read in if needed
if(!exists("countrySampled")){
  countrySampled <- base::readRDS("OccCurve_spCou/2.4c_countrySampled_spCou.Rda")
}
...
combined_count_ChaoiNext <- country_iNextSamples %>%
  ...
  dplyr::arrange( `95%Upper`) %>%
  # Add a column with group numbers, and then make them into groups of ten
  dplyr::mutate(groupNo = ceiling(dplyr::cur_group_id()/10)) %>%
  dplyr::group_by(groupNo)
...
ggplot2::ggsave(file = "2.4c_countrySampled.pdf", 
                path = paste0(RootPath, "/OccCurve_spCou/Figure_outputs"),
...
# Save
continentSampled %>%
  base::saveRDS(., file = "OccCurve_spCou/2.4d_continentSampled.Rda")
# Read in if needed
if(!exists("continentSampled")){
  continentSampled <- base::readRDS("OccCurve_spCou/2.4d_continentSampled.Rda")
}
...
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","2.5dII_violinIterativePlots_
                                     Taxo.pdf"),
                   plot = country_top10_violin,
                   base_width = 10,
                   base_height = 7)
...
combinedStatistics <- combinedStatistics_sampled_country %>%
...
# Save this file
readr::write_excel_csv(combinedStatistics, file = "OccCurve_spCou/Table_outputs/3.1a_combinedStatistics.csv")
if(!exists("combinedStatistics")){
  combinedStatistics <- readr::read_csv("OccCurve_spCou/Table_outputs/3.1a_combinedStatistics.csv")
}
...
# save
readr::write_excel_csv(combinedStatistics, file = "OccCurve_spCou/Table_outputs/3.1c_combinedStatistics_longer.csv")
...
if(!exists("country_summary")){
  country_summary <- readr::read_csv(paste0("/Users/jamesdorey/Desktop/Uni/My_papers/BeeDiversityEstimates/BDE_R_wofklow/OccCurve_spCou/Figure_outputs/country_iNEXT",
                                            "/2.3b_countryTable.csv"))
}
if(!exists("continent_summary")){
  continent_summary <- readr::read_csv(paste0("/Users/jamesdorey/Desktop/Uni/My_papers/BeeDiversityEstimates/BDE_R_wofklow/OccCurve_spCou/Figure_outputs/country_iNEXT",
                                              "/2.3c_continentTable.csv"))
}
if(!exists("combinedStatistics")){
  combinedStatistics <- readr::read_csv(paste0("OccCurve_spCou/Table_outputs/3.1c_combinedStatistics_longer.csv"))
}
...
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","3.2d_countryBoxplot_TOP_BOTTOM.pdf"),
                   plot = countryBoxplot_TOP_BOTTOM,
                   base_width = 8,
                   base_height = 9)
...
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","3.2d_suppBarPlots.pdf"),
                   plot = barPlots_supp,
                   base_width = 15,
                   base_height = 10)
...
allCountryMaps <- cowplot::plot_grid(obsRich_map, NULL,
                                     ...
                                     ncol = 2, align = 'v', axis = 'l')
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","4.4h_countryMaps.pdf"),
                   plot = allCountryMaps,
                   base_width = 12,
                   base_height = 12)
...
allcontinentMaps <- cowplot::plot_grid(obsRich_mapContinent, NULL,
                                       ...
                                       ncol = 2, align = 'v', axis = 'l')
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","4.5h_continentMaps.pdf"),
...
(contCountry_map <- cowplot::plot_grid( iChaoIncrease_map + ggplot2::ggtitle("Undescribed species (iChao)"),    
                                        ...
                                        ncol = 2, align = 'v', axis = 'l'))
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","4.6_contCountry_Maps.pdf"),
...
# Initial download:
#globalDEM <- geodata::elevation_global(res = 0.5, path = "OccCurve_spCou/CorrelatesData")
# Re-read in again
...
# Save these data
readr::write_excel_csv(countryElevations, "OccCurve_spCou/CorrelatesData/countryElevations.csv")
...
# Save these data
readr::write_excel_csv(countryElevations_var, "OccCurve_spCou/CorrelatesData/countryElevations_var.csv")
...
roads <- terra::vect("OccCurve_spCou/CorrelatesData/groads-v1-global-gdb/gROADS_v1.gdb") %>%
  sf::st_as_sf() %>%
...
# Save these data
readr::write_csv(countryDistances, "OccCurve_spCou/Table_outputs/5.1e_countryDistances.csv")
...
combined_explanatory <- combinedStatistics %>%
  ...
  # Save this file
  readr::write_excel_csv(., paste0(RootPath, "/OccCurve_spCou/CorrelatesData/combined_explanatory.csv"))

if(!exists("combined_explanatory")){
  combined_explanatory <- readr::read_csv("OccCurve_spCou/CorrelatesData/combined_explanatory.csv")
}
...
(obsRichprop_in <- ggplot2::ggplot(data = combined_explanatory, 
    ...
    ggplot2::geom_point() + 
    ggplot2::geom_smooth(method = "lm") +
    ggplot2::ylab("Log clean bee occurrence records") + ggplot2::xlab("Log proportion of species with occurrences") +
    {if(showLabels == TRUE)
      ggplot2::geom_text(hjust=0, vjust=0) 
    } +
    ggplot2::theme_classic())
...
(effects_in <- cowplot::plot_grid(GPDc_in, perEd_in,
                                  ...
                                  ncol = 2, align = 'v', axis = 'l'))
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","5.2a_effectsIncrease.pdf"),
                   plot = effects_in,
                   base_width = 10,
                   base_height = 13)
...
plot(combined_explanatory$propOccurrences %>% log, combined_explanatory$iChao_increasePercent %>% log)
plotly::plot_ly(data = combined_explanatory,
                x = ~(propOccurrences),  
                y = ~log(cleanRecords), 
                z = ~log(iChao_increasePercent), 
...
(obsRichprop_per <- ggplot2::ggplot(data = combined_explanatory, 
    ...
    ggplot2::geom_point() + 
    ggplot2::geom_smooth(method = "lm") +
    ggplot2::ylab("Log proportion of species w. occurrences") + ggplot2::xlab("Log clean bee occurrene records") +
    {if(showLabels == TRUE)
      ggplot2::geom_text(hjust=0, vjust=0) 
    } +
    ggplot2::theme_classic())
...
(effects_per <- cowplot::plot_grid(GPDc_per, perEd_per,
                                   ...
                                   ncol = 2, align = 'v', axis = 'l'))
# Save the plot
cowplot::save_plot(filename = paste0("OccCurve_spCou/Figure_outputs/","5.2b_effectsPercent.pdf"),
                   plot = effects_per,
                   base_width = 10,
                   base_height = 13)
...
# Save the plot
ggplot2::ggsave(paste0("OccCurve_spCou/Figure_outputs/","5.2c_lm_inPer_plot.pdf"), 
                plot = lm_inPer_plot, 
